...
function Register(props) {
    ...
    const registerUser = async()=>{
        ...
        if (result.status_code === 201){
            // let secretPhrase = [];
            // for (let i; i < result.secret_phrases.length, i++;){
            //     secretPhrase.push(result.secret_phrases[i]);
            // }
            // props.setSecretPhrases(secretPhrase);
            ...
            if (result.error){
                ...
                document.getElementById('username').nextElementSibling.textContent = result.error;
            }
            else{
                ...
                <div className="wrapper">
                    <form>
                        ...
                        <div className="center">
                            <Link hidden className="secure-wallet" to="/secure-wallet"></Link>
